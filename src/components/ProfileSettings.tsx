...
import { Loader2, Camera, Save, KeyRound, User as UserIcon, Mail } from "lucide-react";
      ...
      <div className="bg-background rounded-2xl border border-border p-6">
        <div className="flex items-center gap-5">
          <div className="relative">
            <div className="w-24 h-24 rounded-full overflow-hidden bg-gradient-blue flex items-center justify-center text-white text-3xl font-display font-extrabold shadow-medium">
              {profile?.avatar_url ? (
